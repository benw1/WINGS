...
def parse_all():
    ...
    parser.add_argument('--FORMAT',   '-fmt', dest='fmt',  default='png', help='Format of saved figures')
    parser.add_argument('--XMIN', '-x1', type=float, dest='xlim1', default=[], help='Color axis blue limit')
    parser.add_argument('--XMAX', '-x2', type=float, dest='xlim2', default=[], help='Color axis red limit')
    parser.add_argument('--YMIN', '-y1', type=float, dest='ylim1', default=[], help='Mag axis faint limit')
    parser.add_argument('--YMAX', '-y2', type=float, dest='ylim2', default=[], help='Mag axis bright limit')
    parser.add_argument('--BINSIZE',   '-bin', type=float, dest='binsize', default=[], help='Histogram bin size')
    parser.add_argument('--LEVELS',    '-lvl', dest='levels', default=[], help='Contour levels')
    parser.add_argument('--THRESHOLD', '-thr', type=float, dest='threshold', default=[], help='Threshold for triggering countours')
    parser.add_argument('--PID', '-pid', dest='pid', default=[], help='Process ID')
    parser.add_argument('--GRID', '-grid', type=int, dest='grid', default=4, help='Spatial grid per axis')
    parser.add_argument('--TARGET', '-targ', dest='target', default=[], help='Name of Target')    
